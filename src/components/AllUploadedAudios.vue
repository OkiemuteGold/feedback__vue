    ...
    <div>
        <div class="form-group tab" v-if="isFeedbackAvailable">
            ...
            >
                ...
                <p>
                    <span class="sub_title">Audio Name:</span>
                    {{ feedback.UploadedAudioName }}
                </p>
                <p>
                ...
                <p>
                    <span class="sub_title">Modified Date:</span>
                ...
                <audioUploadModal :feedback="feedback" :index="index" />
...
import audioUploadModal from "./extra/audioUploadModal.vue";
...
export default {
    ...
    methods: {
        nextPrevFeedback() {
            ...
            this.displayedFeedbacks = this.allFeedbacks.slice(x, y);
        },
